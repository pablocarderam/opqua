...
model.createInterconnectedPopulations(
    ...
    host_contact_rate=1e-2, vector_contact_rate=1e-2,
...
model.linkPopulationsHostContact('population_A','clustered_population_4',1e-2)
model.linkPopulationsVectorContact('clustered_population_4','population_A',1e-2)
    ...
    # not require this)
model.linkPopulationsHostContact('population_A','population_B',1e-2)
model.linkPopulationsVectorContact('population_B','population_A',1e-2)
